...
if(!/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)){
    ...
    function crsr(){
        ...
        function updateCursor() {
            const transformY = scroll.scroll.instance.scroll.y || 0;  // Current scroll position from LocomotiveScroll
            gsap.to("#crsr", {
                x: left,
                y: top + transformY,  // Adjust for the scroll position
            });
        }
